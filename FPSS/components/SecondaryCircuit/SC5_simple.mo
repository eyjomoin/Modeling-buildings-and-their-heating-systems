...
<p>The pump generates a constant dp so that the mass flow adjusts itself according to the valve position in room_tubing. The flow temperature and ambient temperature are required to control the heat pump.</p>
</html>"),
