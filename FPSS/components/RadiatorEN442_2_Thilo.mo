...
model RadiatorEN442_2_Thilo "Dynamic radiator for space heating"
  ...
  Modelica.Blocks.Interfaces.RealOutput Qflow_radiator(unit="W")=Q_flow annotation (Placement(
        transformation(
        origin={0,-120},
        extent={{20,-20},{-20,20}},
