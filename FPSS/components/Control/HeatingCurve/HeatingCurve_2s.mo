...
equation
  (TSupSet,slope,n) =
    FPSS.components.Control.HeatingCurve.Functions.HeatingCurve_two_setpoints_3outputs(
    T_amb1=T_amb1,
    T_set1=T_set1,
    T_amb2=T_amb2,
    T_set2=T_set2,
...
<p>Models a heating curve with the aid of two set points. Between those two points there is a linear function. Behind these points the supply temperature stays constant.</p>
<p><br><img src=\"modelica://FPSS/Pictures/HeatingCurve2s.png\"/></p>
<p>In the example in the picture, a supply temperature of 45&deg;C would be required at ambient temperatures of -10&deg;C, and approx. 36.7&deg;C at 0&deg; ambient temperature.</p>
<p>Below -10&deg;C and above 20&deg;C the supply temperature stays constant.</p>
</html>"));
end HeatingCurve_2s;
