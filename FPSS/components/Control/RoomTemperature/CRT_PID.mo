...
model CRT_PID
  ...
  Modelica.Blocks.Interfaces.RealInput T_room_set(unit="K") annotation (Placement(
        ...
        rotation=180)));
equation
  connect(PID_valve_room.y, control_valve) annotation (Line(points={{11,0},{20,
          0},{20,-60},{0,-60},{0,-110}}, color={0,0,127}));

  connect(T_room_set, PID_valve_room.u_s) annotation (Line(points={{120,0},{60,
          0},{60,40},{-60,40},{-60,0},{-12,0}}, color={0,0,127}));
  connect(Temperature_Room, PID_valve_room.u_m) annotation (Line(points={{0,120},
          {0,80},{-80,80},{-80,-20},{0,-20},{0,-12}}, color={0,0,127}));
annotation (
