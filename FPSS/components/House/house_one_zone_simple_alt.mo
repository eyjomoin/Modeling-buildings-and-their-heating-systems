...
model house_one_zone_simple_alt
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor walCap_out(C = Parameter_building.A_wall_in*Parameter_building.dWall_in*Parameter_building.cpWall_in*Parameter_building.rhoWall_in + Parameter_building.A_wall_out*Parameter_building.dWall_out*Parameter_building.cpWall_out*Parameter_building.rhoWall_out,
    T(start=Parameter_building.T_zone_start),
    der_T(fixed=true)) "Thermal mass of outer wall"                                                                                                                                                                                                         annotation (
    Placement(transformation(origin = {27, 45}, extent = {{-13, -13}, {13, 13}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor walRes_out(R = Parameter_building.dWall_out/Parameter_building.A_wall_out/Parameter_building.kWall_out)
    "Thermal resistor for outer wall"                                                                                                                                                                annotation (
    Placement(transformation(origin = {4, -3}, extent = {{66, -11}, {88, 11}}, rotation = 90)));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor conRes_out(R = 1/Parameter_building.hWall_in/(Parameter_building.A_wall_in + Parameter_building.A_wall_out))
    "Thermal resistance for convective heat transfer to outer wall"                                                                                                                                                                     annotation (
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor walCap_roof(C = Parameter_building.A_roof*Parameter_building.droof*Parameter_building.cproof*Parameter_building.rhoroof,
    T(start=Parameter_building.T_zone_start),
    der_T(fixed=true))                                                                                                                                                                                                         "Thermal mass of roof" annotation (
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor walCap_ground(C = Parameter_building.A_ground*Parameter_building.dground*Parameter_building.cpground*Parameter_building.rhoground,
    T(start=Parameter_building.T_zone_start),
    der_T(fixed=true))                                                                                                                                                                                                         "Thermal mass of groundplate" annotation (
    Placement(transformation(origin = {-27, 45}, extent = {{-13, -13}, {13, 13}})));
