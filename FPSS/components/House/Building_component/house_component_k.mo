...
model house_component_k
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor R_cond_conv_e(R = Cd/(CA*Ck*b_adj)) "Thermal resistor for heat transfer from component to outer conditions" annotation (
