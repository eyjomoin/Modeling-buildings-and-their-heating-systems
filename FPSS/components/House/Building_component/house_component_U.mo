within FPSS.components.House.Building_component;
model house_component_U
  ...
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer CU = 0.25 "overall heat transfer coefficient of the component";
  parameter Modelica.Units.SI.CoefficientOfHeatTransfer Ch = 2 "Convective heat transfer coefficient on the inside of the component";
...
parameter Real b_adj = 1 "Adjustment factor, especially used for soil";
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor R_cond_conv_e(R = (1/(CU*b_adj*CA)) - 1/(Ch*CA)) "Thermal resistor for heat transfer from component to outer conditions" annotation (
...
equation
  ...
  connect(rad, res_rad.port_a) annotation (
    Line(points={{-80.5,-10.5},{-68,-10.5},{-68,-10},{-54,-10}}));
  annotation (
    ...
    Documentation(info = "<html><head></head><body><p>Simple Model for heat transfer through a component of a house (e.g. wall, window, roof,...). There are 3 kinds of heat transfer from and to the thermal capacity of the component:</p><p><span class=\"Apple-tab-span\" style=\"white-space: pre;\">	</span>1. Radiative heat transfer from heat port rad (radiator)</p><p><span class=\"Apple-tab-span\" style=\"white-space: pre;\">	</span>2. Convective heat transfer from heat port conv (indor air)</p><p><span class=\"Apple-tab-span\" style=\"white-space: pre;\">	</span>3. Conductive heat transfer through the component to outside air&nbsp;</p><p>The convective heat transfer from wall to outside air is neglected.&nbsp;</p><p>The thermal resistances are calculated with the help of area A, thicknes d, thermal conductivity k and overall heat transfer coefficient U.</p>
</body></html>"));
end house_component_U;
