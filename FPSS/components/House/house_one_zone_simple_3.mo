...
model house_one_zone_simple_3
  ...
  house_component_U wall(CA = Parameter_building.A_wall, Cd = Parameter_building.dWall, Ccp = Parameter_building.cpWall, Crho = Parameter_building.rhoWall, CU = Parameter_building.UWall, Ch = Parameter_building.hWall, T_start = Parameter_building.T_zone_start) annotation(
    Placement(transformation(origin = {-44, 90}, extent = {{-13, -12}, {13, 12}})));
  house_component_U roof(CA = Parameter_building.A_roof, Cd = Parameter_building.droof, Ccp = Parameter_building.cproof, Crho = Parameter_building.rhoroof, CU = Parameter_building.Uroof, Ch = Parameter_building.hroof, T_start = Parameter_building.T_zone_start) annotation(
    Placement(transformation(origin = {-42, 60}, extent = {{-13, -12}, {13, 12}})));
  house_component_U ground(CA = Parameter_building.A_ground, Cd = Parameter_building.dground, Ccp = Parameter_building.cpground, Crho = Parameter_building.rhoground, CU = Parameter_building.Uground, Ch = Parameter_building.hground, T_start = Parameter_building.T_zone_start) annotation(
