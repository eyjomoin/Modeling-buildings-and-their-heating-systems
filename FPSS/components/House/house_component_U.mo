...
model house_component_U
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor R_cond_conv_e(R = (1/(CU*CA)) - 1/(Ch*CA)) "Thermal resistor for heat transfer from component to outer conditions" annotation(
