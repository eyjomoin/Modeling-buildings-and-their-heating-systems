within FPSS.Einzelkomponenten.Control.BoreholeMassflow;
model CBM1_pump_const
  extends Einzelkomponenten.Control.Partial.icon;
  ...
  FPSS.Einzelkomponenten.Control.signal_inverter_min_max signal_inverter(
      ctr_max=mflow_max, ctr_min=mflow_min)
