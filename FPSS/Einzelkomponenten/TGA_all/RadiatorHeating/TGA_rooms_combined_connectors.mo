...
model TGA_rooms_combined_connectors
  ...
  FPSS.Einzelkomponenten.DataInput.Measurements.DataInput DataInput(DeltaT=-5)
  ...
  POF.Einzelkomponenten.SecondaryCircuit.Distribution_Radiator.distribution_room_combined_connectors
...
equation
  ...
  connect(SecondaryCircuit.FluidPort_HP_sec_in, HeatPump.port_a1) annotation (
      Line(points={{72.1,-18.3},{44,-18.3},{44,-14}}, color={0,127,255}));
  connect(HeatPump.port_b1, SecondaryCircuit.FluidPort_HP_sec_out)
    annotation (Line(points={{44,6},{44,8.3},{72.1,8.3}}, color={0,127,255}));
